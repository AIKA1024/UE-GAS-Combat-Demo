...
/**
 * 攻击招式基类（玩家连段招与敌人招式共用）：
 *  - 激活时自动携带 State.Attacking（供受击 GA 的 Cancel/Block 使用）
 *  - 激活期间监听 AttackHit 事件，命中目标后做伤害结算
 * 子类在 BP 里配攻击蒙太奇（挂 FT_NormalAttackState 通知）与 Damage。
 */
UCLASS()
